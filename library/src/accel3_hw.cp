...
void accel3_latched_interrupt1_enable( _Bool  enable)
{
 ...
 accel3_hal_read( &reg, &temp, 1 );
#line 281 "//VBOXSVR/corey/Projects/ClickLibraries/Accel3_Click/library/src/accel3_hw.c"
 temp |= 0x04;
 accel3_hal_write( &reg, &temp, 1 );
}
...
int8_t accel3_int1_signal_config(int_signal_t config)
{
 uint8_t temp;
 uint8_t reg =  0x22 ;
#line 307 "//VBOXSVR/corey/Projects/ClickLibraries/Accel3_Click/library/src/accel3_hw.c"
 accel3_hal_read( &reg, &temp, 1);
 temp |= config;
 accel3_hal_write( &reg, &temp, 1 );
 return 1;
