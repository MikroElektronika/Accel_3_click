...
#line 45 "//VBOXSVR/corey/Projects/ClickLibraries/Accel3_Click/library/src/accel3_hal.c"
 ...
 unsigned long count,
 unsigned long end_mode );
#line 126 "//VBOXSVR/corey/Projects/ClickLibraries/Accel3_Click/library/src/accel3_hal.c"
...
void accel3_hal_init(uint8_t address_id, uint8_t mode )
{
 if( mode == 0 )
 {
#line 177 "//VBOXSVR/corey/Projects/ClickLibraries/Accel3_Click/library/src/accel3_hal.c"
 start_i2c_p = I2C_Start_Ptr;
 write_i2c_p = I2C_Write_Ptr;
 read_i2c_p = I2C_Read_Ptr;
#line 254 "//VBOXSVR/corey/Projects/ClickLibraries/Accel3_Click/library/src/accel3_hal.c"
 _i2c_hw_address = address_id;
 accel_3_hal_cs_high();
#line 260 "//VBOXSVR/corey/Projects/ClickLibraries/Accel3_Click/library/src/accel3_hal.c"
 }
 else if( mode == 1 )
 {
 ...
 uint8_t count )
{
 ...
 while ( ptr-- )
 temp[ i++ ] = *( buffer++ );
#line 309 "//VBOXSVR/corey/Projects/ClickLibraries/Accel3_Click/library/src/accel3_hal.c"
 start_i2c_p();
 write_i2c_p( _i2c_hw_address, temp, i, END_MODE_STOP );
#line 351 "//VBOXSVR/corey/Projects/ClickLibraries/Accel3_Click/library/src/accel3_hal.c"
 }
 else if( hal_mode == 1 )
 {
 ...
 uint8_t count )
{
 ...
 {
 uint8_t cmd_size =  1 ;
#line 375 "//VBOXSVR/corey/Projects/ClickLibraries/Accel3_Click/library/src/accel3_hal.c"
 start_i2c_p();
