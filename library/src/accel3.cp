...
uint8_t accel3_set_interrupt1( uint8_t threshhold, uint8_t duration )
{
 ...
 accel3_interrupt1_x_high_enable(  0  );
 accel3_interrupt1_x_low_enable(  0  );
 accel3_interrupt1_y_high_enable(  0  );
 accel3_interrupt1_y_low_enable(  0  );
 accel3_interrupt1_z_low_enable(  1  );
 accel3_interrupt1_z_high_enable(  0  );
